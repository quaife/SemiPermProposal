...
spaces\label{subsubsec:delivery_drug_cargos}}
...
\vspace*{-11pt}
\caption{\label{fig:DeepPores} \footnotesize (a) Deep pores in
  intestinal villi, (b) targeted delivery of drug cargos in deep
  dead-end pores via osmophoresis.}
\end{wrapfigure}

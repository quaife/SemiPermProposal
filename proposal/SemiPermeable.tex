...
\input vs_macros.tex
\newcommand{\invis}{\textcolor{white}}
\newcommand{\beq}{\begin{equation}}
\newcommand{\eeq}{\end{equation}}
\newcommand{\beqs}{\begin{eqnarray}}
\newcommand{\eeqs}{\end{eqnarray}}
\newcommand{\kappaF}{$\kappa^{\rm fast}_0$}
\newcommand{\kon}{k_{\rm on}}
\newcommand{\koff}{k_{\rm off}}
\newcommand{\rhoAZ}{$\rho_{\rm AZ}$}
\newcommand{\fx}{{\bf x}}
\newcommand{\fX}{{\bf X}}
\newcommand{\ff}{{\bf f}}
\newcommand{\mA}{{\bf A}}
\newcommand{\mI}{{\bf I}}
\newcommand{\mU}{{\bf U}_0}
\newcommand{\ut}{{\mathbf t}}
\newcommand{\un}{{\mathbf n}}
\newcommand{\ub}{{\mathbf b}}
\newcommand{\xa}{{\mathbf x}_{\alpha}}
\newcommand{\xaa}{{\mathbf x}_{\alpha\alpha}}
\newcommand{\fF}{{\bf F}}
\newcommand{\fP}{{\bf P}}
\newcommand{\fn}{{\bf n}}
\newcommand{\fy}{{\bf y}}
\newcommand{\mup}{{\bf u}'}
\newcommand{\mR}{{\bf R}}
%\newcommand{\hmRk}{\hat{\bf R}_{lk}}
\newcommand{\hmRk}{\hat{\bf R}'}
%\newcommand{\hmRkp}{\hat{\bf R}_{k'}}
\newcommand{\hmRkp}{\hat{\bf R}'}
%\newcommand{\mRk}{{\bf R}_{lk}}
\newcommand{\mRk}{{\bf R}'}
%\newcommand{\mRkp}{{\bf R}_{lk'}}
\newcommand{\mRkp}{{\bf R}'}
\newcommand{\us}{\hat{\bf s}}
\newcommand{\uxi}{{\bf x}_{is}}
\newcommand{\ux}{{\bf x}_{s}}
\newcommand{\uxl}{{\bf x}_{ls}}
\newcommand{\usi}{\hat{\bf s}_i}
\newcommand{\usj}{\hat{\bf s}_j}
\newcommand{\bmu}{\bar{\mu}}
\newcommand{\Cal}{Ca\textsuperscript{2+}\xspace}
...
\begin{figure}[h]
\begin{center}
\includegraphics*[keepaspectratio=true,scale=0.45]{figs/Illustration_Osmosis.pdf}
...
%(b) Osmophoresis of a vesicle with permeability $\kappa$ at a velocity $u$ due to a 
%solute gradient $\nabla c$. $\mu_1$ is the viscosity of inner fluid, and $\mu_2$ is the viscosity of outer fluid.
}
...
% (Fettiplace and Haydon 1980, Olbrich et al. 2000). 
...
%with collaborator Y. Mori (University of Minnesota) 
...
%{\bf note: what kind of non-Newtonian fluid will be used in experiments? How about poroelastic fluid from \cite{Bertrand2016_PRApplied,EngelsbergBarros2013_PRE}? 
%Is there any reference in terms of mechanical properties? Lam\'e coefficient? Poisson coefficient?}
...
% (Zhou et al. 2013, Moeendarbary et al. 2013). 
...
%The poroelastic fluid inside the vesicle may be replaced with a non-Newtonian fluid. 
...
%PI Young will 
%Furthermore,  we will solve the transport equations in complex geometries to estimate the chemical 
%gradients needed to achieve such a motion, addressing the possibility of osmophoresis in biological environment for self-organization.
...
\vspace*{-7pt}
%\subsection{Theological Impacts}
%This proposal seeks to identify an overlooked transport mechanism for biological particles. The proposed research will provide a rigorous characterization of the mechanism that has a potential to be responsible for a variety of biological processes such as polarized cell growth, negative chemotaxis, endo/exocytosis, self-organization, etc. In addition, the proposed research is focused on not only the fundamental understanding of the phenomena, but also suggests possible applications in biomedical systems such targeted drug delivery. Delivering drug cargos into deep, confined spaces such as intestine, lung, tumor, and skin is extremely challenging due to their lack of ability to reach the targeted area. The proposed research will suggest a new strategy to achieve targeted drug delivery in hard-to-reach spaces, which have the potential to impact pharmaceuticals and other related areas in biomedicine and biotechnology.
%\subsection{Educational Impacts and Outreach Program}
...
%PI Young received research support from a prior relevant NSF grant CBET-0853673 
%(Direct numerical simulations of elastic filament suspensions and multi-scale modeling of soft-particle suspensions, \$ 159,793, 
%9/01/2009--8/31/2011, PI).
%The focus of this grant is to design an efficient numerical method for simulating the suspension flow of elastic filaments to
%quantify the relation between the macroscopic properties of filament suspension and the microstructural filament dynamics.
%
%{\it Intellectual merit:}   Six papers resulted from work supported by this grant (\cite{Blawzdziewicz2010_PhysicaD,Bouzarth2011,Veerapaneni2011_PRL,Vlahovska2011_JFM,Young2009_PRE,Young2010_PRE}) in two years
%studying fluid-structure interaction \cite{Bouzarth2011,Veerapaneni2011_PRL,Vlahovska2011_JFM,Young2009_PRE,Young2010_PRE} 
%and how the macroscopic fluid properties depend on the dynamics of suspension particles \cite{Blawzdziewicz2010_PhysicaD,Veerapaneni2011_PRL}.
%%(1) Development of small-deformation theory for a compound vesicle enclosing a nucleus \cite{Veerapaneni2011_PRL}.
%%(2) Nonlinear analysis on a non-spherical microcapsule in shear flow \cite{Vlahovska2011_JFM}.
%%(3) Modelling a semi-flexible filament in Stokes flow using regularized Stokeslets \cite{Bouzarth2011}.
%%(4) Nonlinear hydrodynamic phenomena in Stokes flow regime \cite{Blawzdziewicz2010_PhysicaD}.
%%(5) Dynamics of a polar filament (such as an actin filament) in Stokes flow \cite{Young2010_PRE}.
%%(6) Hydrodynamic interactions between two semi-flexible filaments in Stokes flow \cite{Young2009_PRE}.
%%
%
%{\it Broader impacts:} 
%The hydrodynamics of a compound vesicle is presented in \cite{Veerapaneni2011_PRL}. The hydrodynamic interactions
%between filaments in Stokesian flow are quantified \cite{Young2009_PRE}.
%A PhD student (Herve Nganguia from Congo, Africa) was supported by this grant, 
%and PI Young has been actively involved with promotion of minority undergraduate and graduate students at NJIT. 
%In addition PI Young has taught a broad
%spectrum of courses in applied math.
%%fluid mechanics, applied math modeling, and complex fluids.
...
\bibliography{bibliography_SSd,AM2015}
